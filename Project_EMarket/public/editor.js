    ...
    var methods = {
        ...
        imageWidget: function() {
            ...
            var navTabs = $('<ul/>', {
                ...
                class: "active btn btn-teal"
            }).append($('<a/>', {
                "href": "#uploadImageBar_" + _idSuffix,
                "data-toggle": "tab"
            }).html("From Computer"))).append($('<li/>', { class: "btn btn-dark" }).append($('<a/>', {
        ...
        init: function(options) {
            ...
            $(document.body).mousedown(function(event) {
                ...
                if (!target.parents().andSelf().is('#specialchar') && (target.closest('a').html() != '<i class="fas fa-asterisk"></i>')) { //Clicked outside
                    if ($("#specialchar").is(':visible')) {
                        $(editor_Content).data("editor").data("splcharsBtn", null);
                        $('#specialchar').remove();
                    }
                }
                if (!target.parents().andSelf().is('#paletteCntr') && (target.closest('a').html() != '<i class="fas fa-font"></i>')) { //Clicked outside
        ...
        createMenuItem: function(itemSettings, options, returnElement) {
            ...
            if (itemSettings["select"]) {
                ...
                menuWrapElement.append($('<a/>', {
                    class: "btn btn-xs btn-outline-primary waves-effect dropdown-toggle",
                ...
                var menuWrapElement = $("<a/>", { href: 'javascript:void(0)', class: 'btn btn-xs btn-outline-primary waves-effect' });
                var menuElement = $("<i/>");
                if (itemSettings["icon"])
                    menuElement.addClass(itemSettings["icon"]);
                else
